  ...
  return (
    <div className="rounded-lg shadow-md ">
        ...
        <div className="px-6 py-4">
            ...
            <div className='flex justify-center mt-2 mb-0'><span className='text-sm'>starts in <p className='inline-block text-red-700 font-bold'>3:05 mins</p></span></div>
            ...
            <div className="flex min-w-fit justify-center bg-darkish-green border-[1.5px] border-white mb-1 p-1 rounded-md items-center hover:bg-gradient-to-tl from-[#84bab4] to-darkish-green">
              <Link href={links} className="text-l text-light-green font-semibold">Join</Link>
