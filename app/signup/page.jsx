        ...
        <div className='shrink flex sm:flex-row just bg-white w-3/4 m-2 sm:m-8 min-w-fit shadow-xl gap-0'>
            ...
            <div className='flex-auto grow flex flex-col sm:justify-center items-center w-full sm:w-4/6'>
                ...
                <form className='flex flex-col justify-center items-center'>
                    ...
                    <input type='text' id='username' name='username' className='w-40 sm:w-64 h-10 border border-gray-300 rounded-2xl px-4 mt-4' placeholder='Username' required/>

                    <label for='password'></label>
                    <input type='password' id='password' name='password' className='w-40 sm:w-64 h-10 border border-gray-300 rounded-2xl px-4 mt-4' placeholder='Password' required></input>
                    ...
                    <button type='submit' className='m-6 py-2 px-12 bg-[#38B398] rounded-xl text-sm font-semibold border text-white'>Sign Up</button>
