        ...
        <div className='shrink flex flex-col sm:flex-row just bg-white w-3/4 m-8 min-w-fit shadow-xl gap-4 sm:gap-0'>
            ...
            <div className='flex-auto grow flex flex-col justify-center items-center w-full sm:w-2/3'>
                ...
                <form className='flex flex-col justify-center items-center'>
                    ...
                    <input type='email' id='username' name='username' value={email}  onChange={(e) => setEmail(e.target.value)} className='w-40 sm:w-64 h-12 border border-gray-300 rounded-2xl px-4 mt-4' placeholder='Email' required/>

                    {/* <label for='password'></label> */}
                    <input type='password' id='password' name='password' value={password}  onChange={(e) => setPassword(e.target.value)} className='w-40 sm:w-64 h-12 border border-gray-300 rounded-2xl px-4 m-4' placeholder='Password' required></input>

                    {/* <label for='remember' className='text-sm'> */}
                        {/* <input type="checkbox" id="remember" name="remember" /> Remember me */}
                    {/* </label> */}
                    
                    <button onClick={handleSignIn} className='m-6 py-2 px-12 bg-[#38B398] rounded-xl text-sm font-semibold border text-white'>Login</button>
